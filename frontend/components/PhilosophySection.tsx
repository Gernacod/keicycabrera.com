    ...
    return (
        <section className="w-full bg-[#0097b2] py-[80px] px-4 md:px-[60px] font-primary relative overflow-hidden">
            <div className="max-w-[1440px] mx-auto grid grid-cols-1 xl:grid-cols-[1fr_1fr] gap-[60px] items-center">
                ...
                {/* Video Column */}
                <div className="w-full h-[600px] xl:h-[785px] bg-[#f7f4f1] rounded-[20px] shadow-[-2px_4px_4px_0px_rgba(0,0,0,0.25)] flex items-center justify-center relative overflow-hidden group cursor-pointer">
                    {/* Play Button */}
                    <div className="w-[120px] h-[120px] bg-[#0e5587] rounded-full flex items-center justify-center shadow-[2px_4px_4px_0px_rgba(0,0,0,0.25)] z-20 group-hover:scale-110 transition-transform duration-300">
                        <Play className="w-[50px] h-[50px] text-white fill-current ml-2" />
                    </div>

                    {/* Video Placeholder / Actual Video */}
                    <div className="absolute inset-0">
                        {/*  Use an img or video tag here. For now mimicking the minimalist placeholder style from design */}
                        <video
                            className="w-full h-full object-cover opacity-90"
                            src="/wp-content/uploads/2025/01/VIDEO-2024-10-25-12-30-14.mp4"
                            muted
                            loop
                        // poster="/wp-content/uploads/2025/01/VIDEO-2024-10-25-12-30-14-poster.jpg"
                        />
                    </div>
                </div>
