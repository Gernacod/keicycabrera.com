        ...
        <section className="bg-[#0097b2] content-stretch flex flex-col gap-[40px] items-start px-[20px] md:px-[40px] py-[60px] relative shrink-0 w-full" id="recursos">
            ...
            <div className="content-stretch flex flex-col gap-[40px] items-center relative shrink-0 w-full">
                <div className="content-stretch grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[20px] md:gap-[30px] relative w-full">
                    {resources.map((res, i) => (
                        <ScrollReveal key={i} direction="up" delay={0.3 + i * 0.1} scale={0.9} className="w-full">
                            <div className="bg-white flex flex-col gap-[20px] md:gap-[30px] h-[280px] md:h-[328px] items-center justify-center overflow-clip p-[20px] relative rounded-[20px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] shrink-0 w-full transition-transform hover:scale-[1.02]">
                ...
                <ScrollReveal direction="up" delay={0.7} scale={0.8}>
                    <CtaButton href="/recursos-gratuitos">
