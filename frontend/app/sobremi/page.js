		...
		<main className="min-h-screen bg-white font-['Red_Hat_Display'] overflow-x-hidden">
				...
				<div className="max-w-[1440px] mx-auto flex flex-col md:flex-row items-center justify-center gap-[40px] md:gap-[100px]">
					...
					<div className="flex flex-col gap-0 items-start py-[50px] relative" data-name="Conten2" data-node-id="1:1565">
						{[
							...
							<div key={i} className="flex gap-[31px] items-center relative" data-name="Solution">
			...
			<section className="w-full bg-white py-[80px] px-6 md:px-[80px]">
				<div className="max-w-[1440px] mx-auto flex flex-col items-center gap-10">
					...
					{/* Gallery */}
					<div className="flex overflow-x-auto gap-[30px] w-full pb-6 px-4 no-scrollbar" data-name="Con1" data-node-id="1:1623">
						{[
							"/1.png",
							"/2.png",
							"/3.png",
							...
							<div className="w-full flex justify-center mt-10" data-node-id="1:1636">
								<div className="bg-white border border-[#0e5587] rounded-[20px] shadow-lg flex items-center overflow-hidden w-full max-w-[923px] h-[72px]" data-node-id="1:1637">
									<input
										...
										data-node-id="1:1638"
									/>
									<button className="bg-[#0e5587] text-white font-bold text-[20px] h-full px-10 hover:bg-[#0a4368] transition-all" data-node-id="1:1639">
										Quiero Suscribirme
									</button>
								</div>
							</div>
			...
			<section className="w-full flex flex-col md:flex-row h-auto md:h-[620px]" data-node-id="1:1642">
				{/* Mission */}
				<div className="w-full md:w-1/2 bg-[#0e5587] p-8 md:p-[80px] flex flex-col justify-center items-center text-center text-white gap-10" data-node-id="1:1643">
				...
				{/* Vision */}
				<div className="w-full md:w-1/2 bg-[#0097b2] p-8 md:p-[80px] flex flex-col justify-center items-center text-center text-white gap-10" data-node-id="1:1647">
						...
						<form onSubmit={handleSubmit} className="w-full max-w-[580px] flex flex-col gap-[40px] px-[40px] py-[30px] rounded-[20px]" data-node-id="1:1657">
							...
							<div className="w-full flex justify-center">
								<button
									...
									className="bg-[#0e5587] text-white font-bold text-[20px] leading-normal px-[40px] py-[16px] rounded-[20px] shadow-[2px_4px_4px_0px_rgba(0,0,0,0.25)] hover:bg-[#0a4368] transition-all disabled:opacity-70"
									data-name="BotonS"
									data-node-id="1:1673"
								>
