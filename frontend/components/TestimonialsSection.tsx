    ...
    return (
        <section className="bg-white py-[80px] px-4 overflow-hidden font-primary">
            <div className="max-w-[1440px] mx-auto flex flex-col xl:flex-row items-center justify-between gap-[40px] xl:gap-[100px]">
                ...
                {/* Carousel Area */}
                <div className="relative w-full max-w-[800px] h-[650px] flex items-center justify-center">
                ...
                {/* Right Text */}
                <div className="flex items-center justify-center w-full max-w-[500px] text-center xl:text-left shrink-0">
