    ...
    return (
        <section className="bg-white content-stretch flex flex-col gap-[40px] items-center justify-center p-[20px] md:p-[60px] relative shrink-0 w-full" id="blog">
            ...
            <div className="content-stretch flex flex-col md:flex-row gap-[40px] items-start relative shrink-0 w-full max-w-[1400px]">
                {/* Main Post */}
                <div className="content-stretch flex flex-col flex-1 gap-[10px] items-center min-h-[500px] md:min-h-[600px] overflow-clip p-[20px] md:p-[30px] relative rounded-[20px] self-stretch shadow-[0px_4px_10px_rgba(0,0,0,0.1)] group cursor-pointer transition-all">
                ...
                <div className="content-stretch flex flex-col gap-[40px] items-start justify-start flex-1 relative w-full">
                    {posts.slice(1).map((post, i) => (
                        <div key={i} className="content-stretch flex flex-col gap-[10px] items-center justify-center overflow-clip p-[20px] md:p-[30px] relative rounded-[20px] shadow-[0px_4px_10px_rgba(0,0,0,0.1)] shrink-0 w-full min-h-[250px] group cursor-pointer transition-all">
                            <div className="absolute inset-0 z-0">
                                <img
                                    src={post.image}
                                    alt=""
